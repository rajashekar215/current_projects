...
custid=4784845
documents=mdb.rating_points_testing_users.find({"custid" : custid,"date" :{"$nin":["2019-09-30"]}},{"category":1,"keywords":1,"post_desc":1,"rating":1})
...
#custid=22172222
t4=time.time()
tlist=mdb.rating_points_testing_users.find({"custid" : custid,"date":{"$in":["2019-09-30"]}},{"category":1,"keywords":1,"post_desc":1,"rating":1})
