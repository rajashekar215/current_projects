...
# =============================================================================
        ...
        mdb[active_users_collection].update_one({"custid" : custid},{'$set':{'model_updated':1,'model_uptime':time.time(),'model_last_post_time':new_last_post_time,'avg_time_spent':new_avg_time_spent,"total_posts":new_total_posts}})
    else:
    ...
    if mdb[active_users_collection].count_documents({'model_updated':{'$in':[None,0]}})>0:
        ...
        for user in active_users:
            ...
            if "model_last_post_time" in user and user["model_last_post_time"]:
                last_post_time=user["model_last_post_time"]
        ...
        mdb[active_users_collection].update_many({},{'$set':{'model_updated':0}})
