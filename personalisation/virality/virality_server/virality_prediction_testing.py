...
total_data=pd.read_csv("virality_training_data_telugu.csv")
...
train_total_data=total_data[:100000]
...
model.save("virality_prediction_1L")
tmt=time.time()-mt
...
'''test_total_data=total_data[20000:20100]
...
test_predY=model.predict([np.array(test_final_sentence_matrix)])'''
