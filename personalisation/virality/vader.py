...
NEGATE ={"కాదు", "కాలేదు", "ధైర్యం లేదు", "చేయలేదు", "లేదు","కాకపోవచ్చు", "తప్పక",
 "అవసరం లేదు", "ఎప్పుడూ", "ఏదీ లేదు", "వద్దు", "ఎక్కడా",
 "ఉండకూడదు", "ఉహ్-ఉహ్","లేకుండా", "ఉండదు",  "అరుదుగా", "ఉన్నప్పటికీ"}
...
BOOSTER_DICT = \
{"ఖచ్చితంగా": B_INCR, "అద్భుతంగా": B_INCR, "అద్భుతం": B_INCR, "భయంకరంగా": B_INCR, "పూర్తిగా": B_INCR, "గణనీయంగా": B_INCR,
"గణనీయం": B_INCR, "నిర్ణయాత్మకంగా": B_INCR, "లోతుగా": B_INCR, "అపారంగా": B_INCR,"అపారం": B_INCR,
  "ముఖ్యంగా": B_INCR, "అనూహ్యంగా": B_INCR,"అనూహ్యం": B_INCR, "చాలా": B_INCR,"గొప్పగా": B_INCR,
  "గొప్ప": B_INCR, "అత్యంత": B_INCR, "భారీగా": B_INCR,"భారీగ": B_INCR, "నమ్మశక్యం": B_INCR,"నమ్మశక్యంగా": B_INCR,
 "తీవ్రంగా": B_INCR,"తీవ్రం": B_INCR, "ప్రధానంగా": B_INCR,"ప్రధానం": B_INCR, "మరిన్ని": B_INCR,  "నిజంగా": B_INCR,"నిజం": B_INCR,
  "అసాధారణంగా": B_INCR,"అసాధారణం": B_INCR, "కాబట్టి": B_INCR,"విపరీతంగా": B_INCR,"విపరీతం": B_INCR,"నమ్మదగనిది": B_INCR,
  "నమ్మదగని": B_INCR,"దాదాపు": B_DECR, "కేవలం": B_DECR, "అరుదుగా": B_DECR,"అరుదు": B_DECR, "చాలు": B_DECR,
 "రకమైన": B_DECR, "ఎంతో": B_DECR,"తక్కువ": B_DECR, "కొద్దిగా": B_DECR, "స్వల్పంగా": B_DECR,"స్వల్పం": B_DECR, 
 "అప్పుడప్పుడు": B_DECR, "పాక్షికంగా": B_DECR,"పాక్షికం": B_DECR,"కొంతవరకు": B_DECR,"విధమైన": B_DECR}
